...
import { OrganizationService } from '~ai-agent/modules/organization';
...
export class PacsService implements OnApplicationBootstrap {
  ...
  constructor(
    ...
    private readonly pathService: AiAgentPathService,
  ...
  public onApplicationBootstrap() {
    combineLatest({
      ...
      .subscribe((async value => {
        if (value.isAuthenticated && value.isOrganizationServiceInit && this.organizationService.isAiCompany()) {
